        ...
        <ul>
          <li>
            ...
            <div className="service-text-con">
              ...
              <p>
                I can write algorithms for website development features. I am
                familiar with hypothesis testing, data modeling, and
                mathematics.
              </p>
            </div>
          </li>
          <li>
            ...
            <div className="service-text-con">
              ...
              <p>
                I write Software Documentation. Have a look at some of my
                published articles in the featured section.
              </p>
            </div>
          </li>
          <li>
            ...
            <div className="service-text-con">
              ...
              <p>
                I can help you develop web applications. Check out some of my
